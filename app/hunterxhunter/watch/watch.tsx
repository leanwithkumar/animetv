...
export default function Hunterxhunterwatch() {
  const searchParams = useSearchParams()
  const video = searchParams.get('video')

  return (
    <div className="min-h-screen bg-cover text-white pb-25 pb-25 pt-25 px-4 sm:px-8 flex items-start justify-center"
    style={{
